<h1 align="center"> <a href="https://awesome.re"><img src="https://awesome.re/badge.svg" alt="awesome"></a> Linux </h1>
...
![linux graphic](https://i.imgur.com/3F0xXh8.jpg)
...
![default look](https://distrowatch.com/images/cgfjoewdlbc/centos.png)
...
![default look](https://distrowatch.com/images/cgfjoewdlbc/debian.png)
...
![default look](https://distrowatch.com/images/cgfjoewdlbc/mageia.png)
...
![default look](https://distrowatch.com/images/cgfjoewdlbc/manjaro.png)
...
![default look](https://distrowatch.com/images/cgfjoewdlbc/opensuse.png)
...
#### [Puppy Linux](https://puppylinux.org/)
...
- [LXQt](https://lxqt.org/) - Qt port and the upcoming version of LXDE, the Lightweight Desktop Environment. It is the product of the merge between the LXDE-Qt and the Razor-qt projects: A lightweight, modular, blazing-fast and user-friendly desktop environment.
- [MATE](https://www.mate-desktop.org/) - Provides an intuitive and attractive desktop to Linux users using traditional metaphors. Fork of GNOME 2.
- Pantheon - Default desktop environment originally created for the elementary OS distribution. The desktop has some similarities with GNOME Shell and macOS.
...
- [Blackbox](https://github.com/bradleythughes/blackbox) - Lightweight window manager for the X window system, without library dependencies. Built using C++. - ★ 53 stars, last push 2017-02-02.
- [bspwm](https://github.com/baskerville/bspwm) - Tiling window manager that represents windows as the leaves of a full binary tree. - ★ 8,317 stars, last push 2026-06-19.
...
- [Fluxbox](https://www.fluxbox.org/) - Window manager for X, lightweight and easy to handle but full of features to make an easy and fast desktop experience. Built using C++.
...
- [Spice-Up](https://github.com/Philip-Scott/Spice-up) - Desktop presentation app. - ★ 604 stars, last push 2022-03-22.
...
- [Caprine](https://github.com/sindresorhus/caprine/) - Facebook's Messenger client with some added privacy features. - ★ 7,392 stars, last push 2026-01-02.
- [PB for Desktop](https://github.com/sidneys/pb-for-desktop) - Pushbullet client. - ★ 516 stars, last push 2023-01-06.
- [ramme](https://github.com/terkelg/ramme) - Instagram client. - ★ 3,301 stars, archived 2019-11-03.
- [Whatever](https://github.com/CellarD0-0r/whatever) - Evernote client based on the web version. - ★ 347 stars, last push 2020-10-06.
...
- [dnfdragora](https://github.com/manatools/dnfdragora) - (Fedora) A GUI for the `dnf` package manager. - ★ 192 stars, last push 2026-09-19.
- [Yay](https://github.com/Jguer/yay) - (Arch) Yay is one of the many wrappers to `pacman` which automatically downloads and installs packages from AUR, a full list can be found [here](https://wiki.archlinux.org/index.php/AUR_helpers). - ★ 13,760 stars, last push 2026-09-22.
- [Aura](https://github.com/aurapm/aura) - (Arch) Secure, multilingual package manager. - ★ 1,915 stars, last push 2026-02-05.

Distro-independent:

- [AppImageKit](https://github.com/probonopd/AppImageKit) - Using AppImageKit you can package applications in the [AppImage](https://appimage.org/) format that runs on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one app = one file. - ★ 9,428 stars, last push 2026-07-26.
...
- [fuck](https://github.com/nvbn/thefuck) - Command line tool which corrects your previously mistyped command. - ★ 97,873 stars, last push 2024-07-19.
...
- [ranger](https://github.com/ranger/ranger) - Vim-inspired file manager for the console. - ★ 17,412 stars, last push 2026-09-09.
- [screenFetch](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal. - ★ 4,076 stars, last push 2026-03-02.
- [shellcheck](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts. - ★ 40,080 stars, last push 2026-09-21.
- [speed-test](https://github.com/sindresorhus/speed-test) - Test your Internet connection speed and ping using [speedtest.net](https://www.speedtest.net/). - ★ 3,950 stars, last push 2021-12-03.
- [testdisk](https://www.cgsecurity.org/wiki/TestDisk) - A tool for disk partition recovery.
- [tig](https://github.com/jonas/tig) - Text-mode interface for git. It functions mainly as a Git repository browser. - ★ 13,348 stars, last push 2026-09-19.
...
- [vtop](https://github.com/MrRio/vtop) - Easily-extendable activity monitor. - ★ 4,172 stars, last push 2020-10-08.
- [wavemon](https://github.com/uoaerg/wavemon) - Monitoring application for wireless network devices. - ★ 1,242 stars, last push 2026-06-29.
- [youtube-dl](https://github.com/rg3/youtube-dl) - A tool to download videos from YouTube and other video sites. - ★ 141,328 stars, last push 2026-02-19.
